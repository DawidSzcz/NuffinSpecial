#ifndef DRAWABLE_HEXAGON_HPP
#define DRAWABLE_HEXAGON_HPP

#include <GL/glew.h>
#include "ITranslationVertexShaderDrawable.hpp"

class DrawableHexagon : public ITranslationVertexShaderDrawable {
public:
	DrawableHexagon(const TranslationVertexShader* shader,
					GLfloat radius,
