...
DrawableHexagon::DrawableHexagon(	const TranslationVertexShader* shader,
									GLfloat radius,
...
void DrawableHexagon::SetupBuffers() {
	const int edges_n = 6;
...
void DrawableHexagon::Draw() const {
...
void DrawableHexagon::CleanupBuffers() {
