...
EXTENSIONS=" BLP BMP DCX DDS DICOM WAD EXR FITS GIF HDR ICNS ICON IFF ILBM IWI JPG JP2 LCMS LIF MDL MP3 PCX PCD PIC PIX PNG PNM PSD PSP PXR RAW ROT SGI SUN TEXTURE TGA TIF TPL UTX VTF WAL WBMP WDP XPM"
